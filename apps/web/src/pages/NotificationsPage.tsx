...
import { Bell, MessageSquare, Mail, Smartphone, CheckCircle2 } from "lucide-react";
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm divide-y divide-slate-100 overflow-hidden">
        {notifications.map((n) => (
          <div
            ...
            className={`p-4 sm:p-5 flex items-start space-x-4 hover:bg-slate-50 transition cursor-pointer ${
              n.status !== "read" ? "bg-emerald-50/40" : ""
            }`}
          >
