...
export const IndustryAgreementsPage = () => {
    ...
    return (<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-in fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link to="/industry/marketplace" className="px-4 py-2 bg-slate-900 text-white rounded-xl text-xs font-bold hover:bg-slate-800 transition">
      ...
      <div className="space-y-4">
        {agreements.map((agr) => (<div key={agr.id} className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition space-y-4">
            ...
            <div className="pt-2 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-2">
              ...
              <div className="flex items-center space-x-2">
                <button onClick={() => alert("Downloading official Jharkhand Innovation Bilateral MoU (PDF with digital e-Sign timestamp)!")} className="flex items-center space-x-1 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-semibold transition">
