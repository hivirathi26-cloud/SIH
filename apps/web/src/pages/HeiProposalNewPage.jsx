...
export const HeiProposalNewPage = () => {
    ...
    return (<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div>
          ...
          <select value={selectedProblemId} onChange={(e) => setSelectedProblemId(e.target.value)} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl bg-slate-50 font-semibold focus:ring-2 focus:ring-emerald-500 focus:outline-none">
            {problems.map((p) => (<option key={p.id} value={p.id}>
        ...
        <div>
          ...
          <input type="text" required value={title} onChange={(e) => setTitle(e.target.value)} placeholder="e.g. JalShuddhi: Solar-Powered Nano-Adsorptive Fluoride Filter" className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:outline-none"/>
        </div>
        ...
        <div>
          ...
          <textarea required rows={3} value={summary} onChange={(e) => setSummary(e.target.value)} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:outline-none"/>
        </div>
        ...
        <div>
          ...
          <textarea required rows={3} value={technicalApproach} onChange={(e) => setTechnicalApproach(e.target.value)} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:outline-none"/>
        </div>
        ...
        <div>
          ...
          <textarea required rows={2} value={expectedOutcome} onChange={(e) => setExpectedOutcome(e.target.value)} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:outline-none"/>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="number" required value={estimatedBudget} onChange={(e) => setEstimatedBudget(Number(e.target.value))} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl font-mono font-bold text-emerald-700"/>
          </div>
          ...
          <div>
            ...
            <input type="number" required value={durationMonths} onChange={(e) => setDurationMonths(Number(e.target.value))} className="w-full text-xs sm:text-sm p-3 border border-slate-300 rounded-xl font-mono"/>
          </div>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 p-4 rounded-2xl flex items-center justify-between">
          ...
          <input type="checkbox" checked={needsIndustrySupport} onChange={(e) => setNeedsIndustrySupport(e.target.checked)} className="w-6 h-6 text-emerald-600 focus:ring-emerald-500 rounded cursor-pointer"/>
        </div>
