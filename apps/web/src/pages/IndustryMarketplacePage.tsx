...
export const IndustryMarketplacePage: React.FC = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in">
      ...
      <div className="bg-gradient-to-r from-amber-800 via-orange-800 to-slate-900 text-white p-6 sm:p-8 rounded-3xl shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="flex items-center space-x-1.5 px-5 py-3 bg-white text-slate-900 hover:bg-amber-50 rounded-xl text-xs font-bold shadow-md transition"
        >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        <div className="flex items-center space-x-2 flex-1 min-w-[240px]">
          ...
          <input
            ...
            placeholder="Search proposals, universities, tech keywords..."
            className="w-full text-xs p-1.5 focus:outline-none"
          />
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="text-xs p-2 border border-slate-300 rounded-xl bg-slate-50 focus:ring-2 focus:ring-amber-500 focus:outline-none"
          >
        ...
        {filteredProposals.map((prop) => (
          ...
          >
            <div className="space-y-3">
              ...
              {prop.startupIncubationEligible && (
                <div className="flex items-center space-x-1.5 text-[11px] font-bold text-purple-700 bg-purple-50 p-2 rounded-lg border border-purple-200">
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
              ...
              <button
                onClick={() => setSigningProposal(prop)}
                className="flex items-center space-x-1.5 px-5 py-2.5 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-xl text-xs font-bold shadow-md shadow-amber-600/20 transition hover:scale-105"
              >
