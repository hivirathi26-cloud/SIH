...
export const CitizenRatingModal: React.FC<{
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-left">
            ...
            <textarea
              ...
              placeholder="e.g. The water filtration unit is working reliably for 150+ households. Water taste is very clean and children are healthy..."
              rows={3}
          ...
          <button
            type="submit"
            disabled={submitted}
            className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold shadow-md shadow-emerald-600/20 transition hover:scale-105"
          >
