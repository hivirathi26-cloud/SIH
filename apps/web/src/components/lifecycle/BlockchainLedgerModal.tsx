...
import { ShieldCheck, Link2, Hash, CheckCircle2, X } from "lucide-react";

export const BlockchainLedgerModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
        ...
        <div className="max-h-[60vh] overflow-y-auto space-y-3 pr-1">
          {blockchainLedger.map((block) => (
            <div
              ...
              className="bg-slate-900 text-slate-100 p-4 rounded-xl border border-slate-800 font-mono text-xs space-y-2 relative"
            >
